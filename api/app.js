...
var collectionController_1 = require("./controllers/collectionController");
var app = express();
...
router.get('/collection', collectionController_1.getAlLCollections);
router.get('/collection/:id', collectionController_1.getCollectionById);
router.post('/collection/create', collectionController_1.createCollection);
